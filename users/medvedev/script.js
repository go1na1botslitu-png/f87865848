...
function initAudioPlayer() {
    ...
    audioPlayer.style.transform = 'translateY(10px)';
    audioPlayer.style.transition = 'opacity 0.5s ease, transform 0.5s ease';
    ...
    // Добавляем визуальную обратную связь при воспроизведении
    audioPlayer.addEventListener('play', function() {
        const authorContainer = document.querySelector('.author-message-container');
        authorContainer.style.boxShadow = '0 15px 35px rgba(255, 215, 0, 0.3)';
        authorContainer.style.transition = 'box-shadow 0.3s ease';
    });
    
    audioPlayer.addEventListener('pause', function() {
        const authorContainer = document.querySelector('.author-message-container');
        authorContainer.style.boxShadow = '0 15px 35px rgba(0, 0, 0, 0.3)';
    });
    
    audioPlayer.addEventListener('ended', function() {
        const authorContainer = document.querySelector('.author-message-container');
        authorContainer.style.boxShadow = '0 15px 35px rgba(78, 205, 196, 0.3)';
        setTimeout(() => {
            authorContainer.style.boxShadow = '0 15px 35px rgba(0, 0, 0, 0.3)';
        }, 1000);
    });
