...
function initAudioPlayer() {
	const audioPlayer = document.querySelector('.author-audio-container');
	if (!audioPlayer) return;
	
	audioPlayer.style.opacity = '0';
	audioPlayer.style.transform = 'translateY(30px)';
	audioPlayer.style.transition = 'opacity 0.8s ease, transform 0.8s ease';
	...
	const audio = document.getElementById('author-audio');
