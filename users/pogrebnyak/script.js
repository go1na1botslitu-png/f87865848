...
function initQuiz() {
    ...
    const roles = {
        ...
        'party-hug-tangerine': {
            title: 'Мандариновый Обнимаер-Фрукт!',
            icon: '🍊🕺',
...
function initAudioPlayer() {
    ...
    // Создаем барабаны для визуализатора
    for (let i = 0; i < 50; i++) {
    ...
    authorContainer.style.transform = 'translateY(30px)';
    authorContainer.style.transition = 'opacity 0.8s ease, transform 0.8s ease';
    
    setTimeout(() => {
        authorContainer.style.opacity = '1';
        authorContainer.style.transform = 'translateY(0)';
    }, 100);
}